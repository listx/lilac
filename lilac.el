...
(add-to-list 'load-path (concat (getenv "LILAC_ROOT") "/deps/elisp/s.el"))
(require 's)
(add-to-list 'load-path (concat (getenv "LILAC_ROOT") "/deps/elisp/compat.el"))
(require 'compat)
(add-to-list 'load-path (concat (getenv "LILAC_ROOT") "/deps/elisp/dash.el"))
(require 'dash)
(add-to-list 'load-path (concat (getenv "LILAC_ROOT") "/deps/elisp/dr-qubit.org"))
(add-to-list 'load-path (concat (getenv "LILAC_ROOT") "/deps/elisp/f.el"))
(add-to-list 'load-path (concat (getenv "LILAC_ROOT") "/deps/elisp/parsebib"))
(add-to-list 'load-path (concat (getenv "LILAC_ROOT") "/deps/elisp/citeproc-el"))
(require 'citeproc)
(require 'oc-csl)
(add-to-list 'load-path (concat (getenv "LILAC_ROOT") "/deps/elisp/emacs-htmlize"))
(require 'htmlize)
(add-to-list 'load-path (concat (getenv "LILAC_ROOT") "/deps/elisp/magit/lisp"))
(require 'magit-section)
(add-to-list 'load-path (concat (getenv "LILAC_ROOT") "/deps/elisp/nix-mode"))
(require 'nix-mode)
