...
/Lilac/ is an addon for Emacs Org mode to make [[https://en.wikipedia.org/wiki/Literate_programming][Literate Programming]] (LP) using [[glossary:
Noweb][Noweb]]-style [cite:@ramsey_1994] references easy. It comes in two parts:

1. =lilac.el=: to be loaded and used when [[glossary: weaving][/weaving/]] [cite:@knuth_1984 98] and [[glossary:
   tangling][/tangling/]] [cite:@knuth_1984 98] from your own Org mode files
   (which use Noweb references), and
...
effort to make /tangling/ (extracting source code from [[glossary: source code block][source code blocks]]) work
...
For the main title page, we customize the font to look a bit more ornate.
...
(concat
 "#+HTML_HEAD: <link rel=\"stylesheet\" href="
   "\"https://fonts.googleapis.com/css2"
     ...
     "&family=Overlock:ital,wght@1,900"
 "\">")
#+end_src
