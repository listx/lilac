...
README.html: README.org
	...
	'.csl-right-inline{margin: 1em 0 0 2em;}<\/style>/' README.html
	__NREF__Makefile-replace-toc-text
#+end_src
...
Below is the overall structure of [[file:lilac.el][=lilac.el=]], the . The =gc-cons-threshold=
...
#+name: __NREF__Makefile-replace-toc-text
#+begin_src makefile
...
,#+HTML_HEAD: "https://fonts.googleapis.com/css2?family=Source+Serif+Pro&family=Source+Code+Pro">
